...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Livewire only replays a small built-in allowlist of middleware (Authenticate,
        // SubstituteBindings, ...) on the AJAX "update" requests behind every wire:click —
        // NOT the full route middleware stack. Without this, CurrentStore never gets
        // rebound past the initial page load, and every subsequent action silently sees
        // every store's data. These four must persist across every Livewire request.
        Livewire::addPersistentMiddleware([
            EnsureSuperAdmin::class,
            EnsureReseller::class,
            ResolveStoreFromUser::class,
            ResolveStoreFromSubdomain::class,
            ResolveDefaultStore::class,
