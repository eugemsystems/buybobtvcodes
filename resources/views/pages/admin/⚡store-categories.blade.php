...
new #[Title('Store Categories')] class extends Component
{
    use WithFileUploads;
    use WithPagination;
...
<div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
    <div class="flex items-center justify-between">
        <div>
            <flux:button :href="route('admin.stores.show', $this->storeId)" variant="ghost" size="sm" icon="arrow-left" wire:navigate>
                {{ $this->store->name }}
            </flux:button>
