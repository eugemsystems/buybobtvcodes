...
new #[Title('Transactions')] class extends Component
{
    ...
    {
        $transaction = Transaction::forStore($this->storeId)->find($this->reprocessingId);
    ...
    {
        return $this->reprocessingId ? Transaction::forStore($this->storeId)->find($this->reprocessingId) : null;
    }
    ...
    {
        $query = Transaction::forStore($this->storeId)
